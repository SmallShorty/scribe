<template>
  <header class="app-header">
    <svg class="logo" width="20" height="20" viewBox="0 0 128 128">
    ...
    >
      <svg v-if="isDark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
